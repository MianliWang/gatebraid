# REHEARSAL JOB B4 (trial stage 1) - a slow, cheap read-only job that exists to be halted by the operator
...
file `_handoff/inbox-b4/STOP` from their own machine, at a moment of their
