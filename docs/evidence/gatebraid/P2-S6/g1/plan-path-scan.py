...
ALLOWED = ("bin/", "docs/evidence/gatebraid/P2-S6/")
...
READ_ONLY_PREFIX = ("fixtures/state-pipeline/", "fixtures/live-shapes/")
...
# For P2-S6 the disclaimed set is larger, because negative criterion N3 names
# its whole frozen-prefix scope INSIDE the plan in order to forbid writing it.
# A path named so that a mechanised criterion can refuse it is the opposite of
# scope creep, and lumping it with a write target would make the check report
# the plan's own guard as a violation.
EXCLUDED_LANES = {"schema/", "fixtures/", "adr/", "protocols/", "templates/",
                  "projects/", "docs/evidence/gatebraid/P2-S5/"}
