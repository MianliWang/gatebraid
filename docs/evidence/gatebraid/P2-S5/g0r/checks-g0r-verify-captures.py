...
a copy of the retained docs/evidence/gatebraid/P2-S5/checks-g0-verify-captures.py
(sha256 6da4169097f627b486d649cc60d14c6d4f10c1dfa9e0887f4394880d19845735), which
three retained Gate 0 captures pin by hash and which is therefore frozen. The
retained original is NOT edited. Exactly one line differs: the CAP domain
constant now names this re-run's captures directory. No rule of the instrument
is changed -- the two layers, their pass/reject criteria and the NOT-COVERED
classification are byte-identical to the original.
"""
