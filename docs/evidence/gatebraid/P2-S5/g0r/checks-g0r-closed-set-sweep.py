...
CAPDIR = sys.argv[1] if len(sys.argv) > 1 else "docs/evidence/gatebraid/P2-S5/g0r/captures"
...
MENTION_CLASS_ISSUES = {6, 7, 8, 10, 12, 13, 14, 15, 16, 19, 20}
...
SELF = [f for f in ALL if os.path.basename(f).startswith("G0R-closed-set-sweep")]
